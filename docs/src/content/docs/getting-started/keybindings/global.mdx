...
Press <kbd>}</kbd> to switch to the next dashboard view, or <kbd>{</kbd> to switch to the previous
dashboard view. The first time you switch to a view in your dashboard, the dashboard runs the
defined query for every section in that view.
