...
Get started using `dehub` to review and manage your GitHub work items.
...
2. Install this extension:
   ...
   ```sh
   gh extension install dlvhdr/gh-dehub
   ```
...
1. Clone the repo
   ...
   ```bash
   # git
   git clone https://github.com/dlvhdr/gh-dehub

   # GitHub CLI
   gh repo clone dlvhdr/gh-dehub
   ```
