...
- The config for the `gh-dehub` repo under [.dehub.yml](https://github.com/dlvhdr/gh-dehub/blob/main/.dehub.yml)
- My config under my dotfiles repo [dlvhdr/dotfiles](https://github.com/dlvhdr/dotfiles/blob/main/nix/module/gh-dehub/configs/config.yml)
- Many other configs found by [searching GitHub](https://github.com/search?q=path%3Agh-dehub%2Fconfig.yml&type=code)
